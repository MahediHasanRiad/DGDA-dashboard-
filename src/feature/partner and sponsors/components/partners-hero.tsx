// ── Recommended Businesses & Advertisers Hero Banner ─────────────────────────
  ...
  return (
    ...
    >
      ...
      <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-1.5 sm:mb-2">
        Recommended Businesses & Advertisers
      </h1>
      <p className="text-blue-200 text-xs sm:text-sm font-normal max-w-2xl leading-relaxed">
        Manage the searchable directory of logistics providers, customs brokers, banks, warehousing, and distinct sponsored industry partners feeding the DGDA Mobile App.
      </p>
    </div>
  );
}
