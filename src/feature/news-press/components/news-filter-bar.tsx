  ...
  return (
    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
      ...
      <div className="flex flex-wrap items-center gap-3">
        {/* Search input */}
        <div
          className="relative flex items-center rounded-xl border transition-colors focus-within:border-blue-500/60"
          style={{
        ...
        >
          ...
          <input
            ...
            className="h-10 w-48 sm:w-64 rounded-xl bg-transparent pl-10 pr-4 text-sm focus:outline-none placeholder:text-slate-500"
      ...
      <button
        ...
        className="flex items-center justify-center gap-2 rounded-xl px-4 py-2 text-xs sm:text-sm font-semibold transition-all duration-150 hover:opacity-90 active:scale-95 shadow-md"
        style={{
          backgroundColor: "var(--color-accent-gold)",
          color: "#0B1728",
        }}
