export function NotificationHeroBanner() {
  return (
    <div
    ...
    >
      ...
      <div className="relative z-10 max-w-2xl">
        ...
        <p className="text-blue-200/90 text-sm font-normal leading-relaxed">
          Compose and broadcast real-time push alerts, customs gate bulletins, and urgent regulatory notices to the DGDA Mobile App users.
        </p>
      </div>
    </div>
  );
