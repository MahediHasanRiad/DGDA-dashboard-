export function AIHeroBanner() {
  return (
    ...
    >
      {/* Decorative AI soundwave / concentric circular arcs */}
      <div
      ...
      <div className="relative z-10 max-w-3xl">
        <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-white mb-2">
          Agent IA DGDA Knowledge Console
        </h1>
        <p className="text-blue-200/90 text-sm font-normal leading-relaxed">
          Manage the knowledge base for the DGDA Mobile App AI Assistant. Train custom Q&A pairs, upload official customs regulations, and calibrate neural intent confidence scores.
        </p>
      </div>
    </div>
  );
